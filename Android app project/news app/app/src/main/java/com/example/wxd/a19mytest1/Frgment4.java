...
public class Frgment4 extends Fragment {
...
//
            ...
            recyclerview4.setAdapter(adapters);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_frgment4, container, false);
        //return view;

        if(!EventBus.getDefault().isRegistered(this)){
            EventBus.getDefault().register(this);
        }
        recyclerview4=view.findViewById(R.id.rv);
    ...
    public void getHttpData(int key){
        ...
        Request request = new Request.Builder()
                .url("https://api.jisuapi.com/news/get?channel=科技&start=0&num=10&appkey=4516133fbf6e29f5").build();
