...
public class Frgment5 extends Fragment {
...
//
            ...
            recyclerview5.setAdapter(adapters);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_frgment5, container, false);
        //return view;

        if(!EventBus.getDefault().isRegistered(this)){
            EventBus.getDefault().register(this);
        }
        recyclerview5=view.findViewById(R.id.rv);
        ...
        refreshLayout =view.findViewById(R.id.refreshLayout5);
    ...
    public void getHttpData(int key){
        ...
        Request request = new Request.Builder()
                .url("https://api.jisuapi.com/news/get?channel=体育&start=0&num=10&appkey=4516133fbf6e29f5").build();
