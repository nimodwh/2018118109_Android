...
public class Frgment6 extends Fragment {
...
//
            ...
            recyclerview6.setAdapter(adapters);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_frgment6, container, false);
        //return view;

        if(!EventBus.getDefault().isRegistered(this)){
            EventBus.getDefault().register(this);
        }
        recyclerview6=view.findViewById(R.id.rv);
        ...
        refreshLayout =view.findViewById(R.id.refreshLayout6);
    ...
    public void getHttpData(int key){
        ...
        Request request = new Request.Builder()
                .url("https://api.jisuapi.com/news/get?channel=军事&start=0&num=10&appkey=4516133fbf6e29f5").build();
